...
const JOURNAL = require(path.join(__dirname, '..', './chapter-04/journal.js'));
...
const {
  ...
  journalEvents,
  max,
} = require(path.join(__dirname, '..', './chapter-04/helpers.js'));
...
const {
  ...
  nth,
  deepEqual,
} = require(path.join(__dirname, '..', './chapter-04/exercises.js'));
